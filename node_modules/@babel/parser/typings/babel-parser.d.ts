...
import { Expression, File } from '@babel/types/lib';
...
export { DecoratorsPluginOptions, FlowPluginOptions, parse, ParseError, parseExpression, ParseResult, ParserOptions, PluginConfig as ParserPlugin, ParserPluginWithOptions, PipelineOperatorPluginOptions, RecordAndTuplePluginOptions, tokTypes, TypeScriptPluginOptions };
