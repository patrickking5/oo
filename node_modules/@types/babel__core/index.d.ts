...
import * as t from "@babel/types/lib";

export { GeneratorOptions, NodePath, ParserOptions, template, traverse, t as types, Visitor };

export type Node = t.Node;
export type ParseResult = ReturnType<typeof import("@babel/parser/typings/babel-parser").parse>;
